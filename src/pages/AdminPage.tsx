...
import { ShieldCheck, Lock, ArrowLeft, Waves, Activity } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#060e1c] text-white flex flex-col justify-between p-4 sm:p-8">
      ...
      <div className="max-w-6xl mx-auto w-full flex items-center justify-between border-b border-white/10 pb-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-[#d4af37] text-xs font-semibold transition-all border border-[#d4af37]/30 cursor-pointer"
            title="Verificar status da sincronização do banco de dados"
          >
      ...
      <div className="max-w-4xl mx-auto w-full my-8 space-y-6">
        {/* Center Action Box */}
        <div className="max-w-md mx-auto w-full p-6 sm:p-8 rounded-3xl bg-[#0c1f38] border border-[#d4af37]/30 shadow-2xl text-center space-y-5">
        ...
        <div className="max-w-2xl mx-auto w-full">
          <SyncDiagnosticCard onOpenFullDiagnostic={() => setDiagnosticOpen(true)} />
        </div>
      </div>

      {/* Sync Diagnostic Modal */}
      <SyncDiagnosticModal isOpen={diagnosticOpen} onClose={() => setDiagnosticOpen(false)} />
