...
import { X, Images, Sparkles, ShieldCheck } from 'lucide-react';
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-[#d4af37]/20 text-[#f3e5ab] text-[11px] font-bold border border-[#d4af37]/30 flex items-center gap-1">
                  <Sparkles className="w-3 h-3 text-[#d4af37]" />
                  Momentos Oficiais
                </span>
              </div>
              <p className="text-xs text-slate-400">
                Registros de treinos no CPB, competições estaduais e nacionais, pódios e confraternizações
              </p>
            </div>
          </div>
        ...
        <div className="p-4 bg-[#060e1c] border-t border-[#1e3a5f] flex items-center justify-between gap-3 text-xs text-slate-400 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <span>Memória visual da ACEDEP Associação</span>
          </div>
